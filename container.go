...
func (a *App) invokeConstructor(constructor interface{}, container map[reflect.Type]interface{}) interface{} {
	...
	for i := 0; i < fnType.NumIn(); i++ {
		...
		if dependency, exists := container[requiredType]; exists {
...
func (a *App) resolveDependencies(controller interface{}, container map[reflect.Type]interface{}) {
